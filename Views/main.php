...
a img{
    ...
    <body>
        ...
        <a class="navbar-brand" href="../Views/main.php"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="32" class="me-2" viewBox="0 0 118 94" role="img">
        ...
        <img src="https://tarunakelapa.files.wordpress.com/2016/02/logo-smkn4.png"></svg>SMK Negeri 4 Kota Bogor</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="main.php?menu=<?php echo base64_encode(1) ?>">Siswa</a>
                <li class="nav-item">
                <a class="nav-link" href="main.php?menu=<?php echo base64_encode(4) ?>">Kelas</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="main.php?menu=<?php echo base64_encode(7) ?>">SPP</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="main.php?menu=<?php echo base64_encode(10) ?>">Petugas</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="main.php?menu=<?php echo base64_encode(13) ?>">Pembayaran</a>
                </li>
            </ul>
            </div>
        </div>
        ...
        <img src="https://tarunakelapa.files.wordpress.com/2016/02/logo-smkn4.png"></svg>SMK Negeri 4 Kota Bogor</a>
            ...
            <div class="footer">
                ...
                <p>Thanks for Coming © Copyright 2021</p>
